...
export default async function AdminDashboard() {
  ...
  return <div className="admin-page"><div className="admin-heading"><div><p className="admin-kicker">OVERVIEW</p><h1>Dashboard</h1><p>Catalogue and administration status for Bearing Mart BD.</p></div></div>
