...
export default async function ProductsPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  const user=await requireAdmin("products.view","/admin/products"); const {q=""}=await searchParams; const [products,options]=await Promise.all([listProducts(q),productFormOptions()]);
