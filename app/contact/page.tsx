...
export default function ContactPage() {
  return <main className="contact-page">
    ...
    <section className="contact-page-content"><div className="contact-details"><p className="eyebrow">VISIT OR CALL US</p><h2>Your reliable<br />bearing partner.</h2><div className="contact-card"><p className="contact-label">Visit our shop</p><address>Bearing Mart BD<br />10, Modonpal Lane<br />Siddique Machineries Market (2nd Floor)<br />Nawabpur, Dhaka-1100</address><div className="contact-numbers"><a href="tel:+8801730015018">+880 1730-015018</a><span>|</span><a href="tel:+8801755621303">+880 1755-621303</a><span>|</span><a href="tel:+8801551816395">+880 1551-816395</a></div><a className="contact-email" href="https://mail.google.com/mail/?view=cm&amp;fs=1&amp;to=contact%40bearingmartbd.com" target="_blank" rel="noreferrer">contact@bearingmartbd.com</a></div></div><ContactForm /></section>
