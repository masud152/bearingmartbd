...
export default function ContactPage() {
  return <main className="contact-page">
    ...
    <section className="contact-page-content"><div className="contact-details"><p className="eyebrow">VISIT OR CALL US</p><h2>Your reliable<br />bearing partner.</h2><div className="contact-card"><p className="contact-label">Visit our shop</p><address>Bearing Mart BD<br />10, Modonpal Lane<br />Siddique Machineries Market (2nd Floor)<br />Nawabpur, Dhaka-1100</address><a href="tel:+8801914528336">+880 1914-528336</a><a className="contact-email" href="mailto:contact@bearingmartbd.com">contact@bearingmartbd.com</a><p className="owner">Md. Shahidul Islam · Proprietor</p></div></div><ContactForm /></section>
